  ...
  public class Form1 : Form
  {
    ...
    private void DoPatch(string isopath)
    {
      FileStream fileStream1;
            fileStream1 = new FileStream(Application.StartupPath + "\\" + "mhp2g.dat", FileMode.Open, FileAccess.Read);
            try
      {
    ...
    private void DoPatchFont(string isopath)
    {
      ...
      FileStream fileStream;
            ...
            try
      {
                fileStream = new FileStream(Application.StartupPath + "\\" + "mhp2g.dat", FileMode.Open, FileAccess.Read);
            }
      catch
      {
        int num = (int) MessageBox.Show("패치에 필요한 파일을 찾지 못 했습니다", "오류", MessageBoxButtons.OK, MessageBoxIcon.Hand);
    ...
    {
            MessageBox.Show("Edited by File");
        }
